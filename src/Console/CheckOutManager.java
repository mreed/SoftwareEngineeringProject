...
public class CheckOutManager implements IOnItemsScanned {
    ...
    public CheckOutManager() {
    	itemScanner.addScanItemListener(this);
    }
    
    public void RequestScanItems(){

        //Get scanned items.
        itemScanner.scanItems();

    }
    @Override
	public void OnItemsScanned(ArrayList<Item> scanned_items) {
    	 double Total;
